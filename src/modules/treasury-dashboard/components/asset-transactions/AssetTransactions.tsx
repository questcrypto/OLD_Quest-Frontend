...
import { AssetTransactionsWrapper, SecondaryText, useStyles, TransactionsPanel, TransactionValue, TransactionStatus, IdText, PrimaryText, ValueText, VerticalDivider, TransactionWrap } from './style'
...
const TransactionEntry = (entry: any, classes: any) => {
    return <Grid container direction="column">
        ...
        <Grid container item xs={12} alignItems="flex-start">
            <Grid item xs={2} container><img src={UpRedArrow} alt="arrow" /></Grid>
