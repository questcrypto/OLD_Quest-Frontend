...
import {
  ...
  HeaderPath,
  HeaderTitle,
  PropertyFormContParent,
  PropertyFormContLeft,
  PropertyFormContRight,
  FormTitleCont,
  FormTitle,
  FormTitleNumber,
  FormSubTitle,
...
const PropertyForm = () => {
  ...
  return (
    <PropertyFormWrapper>
      ...
      {/* ------------------- from here spliting should be taken place --------------------- */}
      ...
      <PropertyFormContParent>
                  ...
                  <Grid item xs={11} container direction="column">
                    <Grid item className={classes.formGroup}>
                      ...
                      <FieldMsgBox>
                        ...
                        <img src={chatIcon} alt="" onClick={() => setVisible(true)} />
                      </FieldMsgBox>
        ...
        {Visible && (
          <PropertyFormContRight>
            <Grid container spacing={3}>
              <Grid item xs={6} className={classes01.paper}>
                Comments
              </Grid>
              <Grid item xs={6} className={classes01.paper}>
                <Close style={{ cursor: 'pointer' }} onClick={() => setVisible(false)} />
              </Grid>

              <Grid item xs={6} className={classes01.center}>
                <h4> Barrera Ramsey</h4>
              </Grid>
              <Grid item xs={6} className={classes01.center}>
                <p>11:26am - 23 oct</p>
              </Grid>
              <Grid item xs={12} className={classes01.left}>
                Please enter first name correctly, As this <br />
                name already exist in our portal
              </Grid>
              <Divider className={classes01.dividerStyle} />

              {/* ------------------ */}

              <Grid item xs={6} className={classes01.center}>
                <h4> Holman Valencia</h4>
              </Grid>
              <Grid item xs={6} className={classes01.center}>
                <p>11:23am - 23 oct</p>
              </Grid>
