        ...
        <Box>
            <HeaderContainer>
                ...
                <Grid container justify="space-between" spacing={2}>
                    <Grid item>
                        <HeaderTitle>
                            {propertyInfo?.propertyDetails ? propertyInfo.propertyDetails.PropertyName : ''}
                        </HeaderTitle>
                    </Grid>
                    <Grid item>
                                        ...
                                        <Paper className={classes.treasuryOwnersPaper} elevation={0}>
                                            <TreasuryOwnerCont>
                                                <div>
                                                    ...
                                                    <InfoBoldTxt>
                                                        {getFullName(propertyInfo.propertyDetails.Fname, propertyInfo.propertyDetails.Lname)}
                                                    </InfoBoldTxt>
                                                </div>
                                                <MailIcon />
                                            </TreasuryOwnerCont>
