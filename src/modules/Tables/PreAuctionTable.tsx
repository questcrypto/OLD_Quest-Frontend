...
const PreAuctionTable = (props: any) => {
  ...
  const handleTreasuryAdminAction = async (auctionDetails: any, propertyVal: any) => {
    ...
    try {
      ...
      await configureBlockchainAuction(startDate, endDate, id, minReserve, slReserve, propertyVal, propidId)
